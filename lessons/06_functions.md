...
- **Более простой код.** Когда код программы разбит на функции, он проще и легче для понимания. Несколько небольших функций 
...
использованием кода.
- **Более простое тестирование.** Когда каждая задача в программе содержится в собственной функции, процессы тестирования и 
...
Этот процесс называется нисходящей разработкой, потому что программист начинает с того, что обращается к самому верхнему
...
инструкциям в области действия переменной. Областью действия переменной является функция, в которой переменная создается. 
...
констант. _Глобальная константа_ — это глобальное имя, ссылающееся на значение, которое нельзя изменить. Поскольку значение
