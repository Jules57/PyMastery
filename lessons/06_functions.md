...
- после первого символа можно использовать буквы от a до z или от А до Z, цифры от 0 до 9 либо символы подчеркивания;
...
# Проектирование программы c использованием функций
...
`global` позволяет функциям модифицировать переменные, объявленные в глобальной области видимости, в то время
как `nonlocal`
